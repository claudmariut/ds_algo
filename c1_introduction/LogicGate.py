...
class BinaryGate(LogicGate):  # Child class. IS-A Relationship
    ...
    def setNextPin(self, source):
        if self.pinA == None:
            self.pinA = source.getFrom()  # Source is the connector object.
        else:
            if self.pinB == None:
                self.pinB = source.getFrom() # Source is the connector object.
            else:
...
class UnaryGate(LogicGate):
    ...
    def setNextPin(self, source):
        if self.pin == None:
            self.pin = source.getFrom()  # Source is the output object.
        else:
